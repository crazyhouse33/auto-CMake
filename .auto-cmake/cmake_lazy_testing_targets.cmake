...
if (PYTHONINTERP_FOUND)
	...
	add_custom_target(full-test
		...
		COMMAND ${CMAKE_CTEST_COMMAND} --build-and-test ${CMAKE_SOURCE_DIR} ${CMAKE_BINARY_DIR} --build-generator ${CMAKE_GENERATOR} --build-target all --test-command ${CMAKE_COMMAND} --build . --target lazy-mem-test
		WORKING_DIRECTORY "${CMAKE_BINARY_DIR}" 
